...
## Experiment
With a population of 350 players, we ran the simulation five times over 150 generations. Figure 4 shows the achieved highest score versus its current generation focusing on the 100.000 score peak. That peak means that the player has achieved its goal.
